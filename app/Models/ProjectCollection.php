    ...
    static function data()
    {
        return [
            ...
            [
                ...
                "type" => "Figma to HTML",
                "images" => [
                    asset("assets/projects/home-speqtait.png")
                ],
                "technology" => ["PHP", "Tailwind CSS", "JavaScript"],
                "link" => "https://speqtait.mdshahidul.com",
                "completed_date"  => "24 July, 2025",
                "active"=> true,
                "description" => "(Figma to HTML) Speqta IT is a business profile website that showcases the services and products offered by the company. It is designed to provide potential customers with an overview of the company's offerings and to encourage them to get in touch for more information. Technology used: PHP, Tailwind CSS, JavaScript.",
            ],
            [
                "name" => "Openminds",
                "category" => "A Business Portolio",
